...
public class CaptureVitals {
	...
	private static final Logger logger = LogManager.getLogger(CaptureVitals.class);
	
	@Test(priority = 1)
	@Given("I want to open the browser7")
	public void i_want_to_open_the_browser7() {
...
//	@DataProvider(name="LoginData")
	...
	public void it_displays_the_home_page_and_access_capture_vitals() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"referenceapplication-vitals-referenceapplication-vitals-extension\"]"))
				.click();
		logger.info("click on capture vitals");
...
//		driver.findElement(By.xpath("//*[@id=\"patient-search\"]")).sendKeys("100J51");
		driver.findElement(By.xpath("//*[@id=\"patient-search\"]")).sendKeys("100HM1");
		// 100J51 100HVL
		Thread.sleep(2000);
...
//	        String filePath = "C:\\Users\\rubin\\eclipse-workspace\\New folder (2)\\RLL_Group6\\src\\test\\resources\\LoginTestData.xlsx";
